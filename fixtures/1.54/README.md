...
| `readme_154_password.rar` | RAR 1.5 encrypted compressed archive. | Derived from `readme_154_normal.rar` by setting `FHD_PASSWORD`, recomputing `HEAD_CRC`, and applying CRYPT_RAR15 to the packed stream. Password is `password`; RAR 3.93 tests it OK. |
...
| `audio_win_names_unpack15.rar` | Audio-shaped compressed payload with Windows long names. | Contains `BoatModernEnglish.wav` and `LICENSE.txt`, both method `0x35`, `UNP_VER = 15`. |
| `audio_dos_names_unpack15.rar` | Same audio-shaped payload with DOS 8.3 names. | Contains `BOATMO~1.WAV` and `LICENSE.TXT`, both method `0x35`, `UNP_VER = 15`. |
...
`readme_154_normal.rar`, `readme_154_password.rar`,
`readme_154_store_solid.rar`, and `readme.EXE`.
...
```text
d60bb4720a49148d928728d70215b4f8a6b6ac68e838f09fa776d626eb0cbae6  audio_win_names_unpack15.rar
9c1deb8e11baa6fa1658c453b26a128a8437cefcbdeef3f4bcc499f6f7720a98  audio_dos_names_unpack15.rar
...
0676b11bdb65f9e2d8aa39a128f54c29c1828882db411b652e7760f6b3d8e2a5  readme_154_password.rar
